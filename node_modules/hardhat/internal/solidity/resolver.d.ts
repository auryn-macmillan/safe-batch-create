...
export declare class ResolvedFile implements IResolvedFile {
    ...
    constructor(sourceName: string, absolutePath: string, content: FileContent, lastModificationDate: Date, libraryName?: string, libraryVersion?: string);
    getVersionedName(): string;
}
export declare class Resolver {
    private readonly _projectRoot;
    private readonly _parser;
    constructor(_projectRoot: string, _parser: Parser);
    /**
