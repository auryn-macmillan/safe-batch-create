...
class HardhatNetworkProvider extends events_1.EventEmitter {
    ...
    async _init() {
        ...
        if (this._forkConfig === undefined) {
            config = Object.assign({ type: "local", hardfork: this._hardfork, networkName: this._networkName, chainId: this._chainId, networkId: this._networkId, initialDate: this._initialDate }, commonConfig);
        }
        else {
            config = Object.assign({ type: "forked", forkConfig: this._forkConfig, forkCachePath: this._forkCachePath }, commonConfig);
        }
