...
export declare const blockTag: t.UnionC<[t.Type<BN, BN, unknown>, t.KeyofC<{
    earliest: null;
    latest: null;
    pending: null;
}>]>;
export declare type BlockTag = t.TypeOf<typeof blockTag>;
export declare const optionalBlockTag: t.Type<BN | "earliest" | "latest" | "pending" | undefined, BN | "earliest" | "latest" | "pending" | undefined, unknown>;
...
export declare const rpcFilterRequest: t.TypeC<{
    fromBlock: t.Type<BN | "earliest" | "latest" | "pending" | undefined, BN | "earliest" | "latest" | "pending" | undefined, unknown>;
    toBlock: t.Type<BN | "earliest" | "latest" | "pending" | undefined, BN | "earliest" | "latest" | "pending" | undefined, unknown>;
