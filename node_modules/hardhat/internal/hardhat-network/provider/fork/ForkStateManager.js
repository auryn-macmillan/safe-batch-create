...
class ForkStateManager {
    ...
    async getContractStorage(address, key) {
        ...
        if (cleared) {
            return ethereumjs_util_1.toBuffer(new Array(32).fill(0));
        }
    ...
    async putContractStorage(address, key, value) {
        ...
        account = account.set("storage", account.get("storage").set(ethereumjs_util_1.bufferToHex(key), ethereumjs_util_1.bufferToHex(value)));
        this._state = this._state.set(hexAddress, account);
    }
